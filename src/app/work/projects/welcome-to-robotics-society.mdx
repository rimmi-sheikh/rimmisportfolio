...
<figure className="w-full max-w-md mx-auto my-6">
  <img src="/images/robotics-welcome-components.jpg" alt="Arduino board with components connected" className="rounded-xl shadow-md" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">
    Above: The chaotic spaghetti of wires I lovingly called a 'clean build'.
  </figcaption>
</figure>
...
<figure className="w-full max-w-md mx-auto my-6">
  <img src="/images/robotics-welcome-final.jpg" alt="Finished project with LCD and servo waving" className="rounded-xl shadow-md" />
  <figcaption className="text-center text-sm text-gray-500 mt-2">
    Final result: a waving servo, flashing lights, music, and zero explosions. Not a bad start.
  </figcaption>
</figure>
